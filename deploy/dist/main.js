...
class TinyComponent extends HTMLElement {
  ...
  subscribe(path, callback) {
    ...
    Object(lodash__WEBPACK_IMPORTED_MODULE_0__["set"])(subscriber, path, [...subscribers, callback]);
  }
...
var TOKEN_TYPE;
(function (TOKEN_TYPE) {
    TOKEN_TYPE[TOKEN_TYPE["SELECTOR"] = 1] = "SELECTOR";
    TOKEN_TYPE[TOKEN_TYPE["BODY_START"] = 2] = "BODY_START";
    TOKEN_TYPE[TOKEN_TYPE["BODY_END"] = 3] = "BODY_END";
...
/* IMPORT */
var css_simple_parser_1 = __webpack_require__(12);
var resolve_1 = __webpack_require__(18);
/* CSS FLATTEN */
...
var stringify_1 = __webpack_require__(16);
var traverse_1 = __webpack_require__(17);
/* PARSER */
