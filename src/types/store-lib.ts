...
export type payload = NAV_MENU | range | searchTerm | removedUrls | currentPage | histories | likedItems | previews | scrollPage;
...
export type SetScrollPage = (payload: scrollPage) => Action;
